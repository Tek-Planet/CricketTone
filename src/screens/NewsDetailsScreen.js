...
function DetailedScreen ()  {
    ...
    return (
          ...
          <View style={styles.scoreBox}>
            ...
            <Text style={styles.score}>Divergences not only signal a potential trend reversal, but they can also be used as a possible.</Text>
          </View>           
...
const styles = StyleSheet.create({
  ...
  scoreBox: {flex:1, padding:10, margin:5, borderRadius:10,   backgroundColor:'#fff',
  elevation: 5, alignItems:'center'
},

  imgFlag: { width:150, height:150, borderRadius:10,   },

  teamName: {color: 'grey', fontSize:20, marginTop:20,marginBottom:10, fontWeight:'bold', },
